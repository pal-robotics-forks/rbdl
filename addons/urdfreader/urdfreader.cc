...
bool URDFReadFromParamServer(Model* model, ModelDatad &model_data, const std::vector<std::string> &tipLinks, FloatingBaseType floatingBaseType, bool verbose){
...
bool URDFReadFromParamServer(Model* model, const std::vector<std::string> &tipLinks,
  ...
  return URDFReadFromParamServer(model, *model->getModelData(), tipLinks, floatingBaseType, verbose);
}
...
bool URDFReadFromURDF(urdf::Model &urdf_model, Model* model, FloatingBaseType floatingBaseType,
  ...
  return URDFReadFromURDF(urdf_model, model, *model->getModelData(), floatingBaseType,
                          joint_names,
                          position_min, position_max,
                          vel_min, vel_max,
                          damping, friction,
