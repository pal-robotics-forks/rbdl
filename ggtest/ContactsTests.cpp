...
protected:
  virtual void SetUp () {
    ...
    child_id = model->AddBody (model_data, *model_data, base_id, Xtrans (Vector3d (0., 0., 0.)), joint_rotzyx, child);
    ...
    child_2_id = model->AddBody (model_data, *model_data, child_id, Xtrans (Vector3d (0., 0., 0.)), joint_rotzyx, child_2);
